window.addEventListener('load', () => {
    ...
    getData.forEach(item => {
        ...
        <div class="containerSize d-flex justify-content-between"><h6 class="sizeTitle fw-bold" style="font-size:12px;">Size:</h6><h6 class="sizeCreate fw-bold" style="font-size:12px;">${item.size}</h6></div>
        </div>
